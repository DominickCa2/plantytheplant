...
import { usePlantStore, useBobStore, useBurgerStore } from "./store";
...
export default function Start() {
  ...
  const { burger, setBurger } = useBurgerStore();
  ...
  const rotateStyle = {
    transform: [{ rotateZ: `${rotateAnim}deg` }]
  };
  ...
  return (
      <View style={{
        ...
        <Animated.View style={{transform: [{ rotate }]}}>
          <SvgUri width="200" height="200" source={require('../assets/guy.svg')} />
        </Animated.View>
        <View style={styles.container}>
          ...
          <Button 
            ...
            color="gray"
            onPress={() => router.push('/cameraThingy')}
          />
        </View>
        {finding && <AppLoader />}
      </View>
